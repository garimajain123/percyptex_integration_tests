...
Scenario: I can check gap report
  ...
  Scenario: I can check gap report for China
           ...
           And the Evaluation Trend Score for question 6 to compare trend is "+0.04"
           And the Importance Score for question 6 to compare trend is "3.87"
           And the Importance Trend Score for question 6 to compare trend is "-0.03"
           And the Gap Score for question 6 to compare trend is "-0.27"
           And the Gap Trend Score for question 6 to compare trend is "-0.07"
           And the Weighted Gap Score for question 6 to compare trend is "-5.22"
           And the Weighted Gap Trend Score for question 6 to compare trend is "-1.32"
